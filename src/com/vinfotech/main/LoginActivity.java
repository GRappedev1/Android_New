...
public class LoginActivity extends Activity implements OnClickListener, HttpResponseListener, GCMRegisterListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLoginWithDoximityBtn = (Button) findViewById(R.id.login_with_doximity_btn);
	...
	private void initAndShowLogoAnim() {
		...
		Animation logoAnim = AnimationUtils.loadAnimation(LoginActivity.this, R.anim.splash_logo_set);
		logoAnim.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				mContainerLl.startAnimation(AnimationUtils.loadAnimation(LoginActivity.this, R.anim.fade_in));
...
//            }
		...
		case R.id.forgot_password_tv:
			Intent reserPasswordIntent = new Intent(this, ForgotPasswordActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RegistrationActivity.REQ_CODE_COUNTRY_DIALOG:
			if (resultCode == RESULT_OK) {
				 ...
				 */
				mobileEditDialog = new MobileEditDialog(this, editMobileNumber, data.getStringExtra("countryCode"),
	...
	private void loginServerRequest(String emailAddress, String password) {
		...
		String jsonData = mHttpRequest.getSignInJSON(emailAddress, Utility.md5(password), RegistrationActivity.DEVICE_TYPE_ID,
				RegistrationActivity.SOURCE_ID, String.valueOf(mIpAddress), mGCMRegId, String.valueOf(mCurLat), String.valueOf(mCurLog),
...
//			if (false) {
//				DialogUtil.showOkDialog(LoginActivity.this, signInParcer.getMessage());
//			} else {
